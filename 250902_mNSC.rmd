...
[cite_start]samples <- read.csv("./input/samples.csv", row.names = 1, header = TRUE) [cite: 1]

# --- Convert all model variables to factors ---
# This ensures DESeq2 treats them as discrete categories, not continuous numbers.
[cite_start]vars <- c("SeqBatch", "Host", "Model", "Driver") [cite: 1]
...
[cite_start]samples_ns1 <- samples[samples$Model == "NS1", ] [cite: 1]
